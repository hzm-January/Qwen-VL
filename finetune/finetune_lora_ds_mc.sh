...
# 4 执行 预测
/data1/llm/anaconda3/envs/hzm-qwen-vl/bin/python3.8 /data1/llm/houzm/99-code/01-Qwen-VL/ai_doctor/test/qwen_lora_diagnose_test_multi_class.py --dir-id $DIR_ID  2>&1 | tee $OUTPUT_DIR/train_model.log
